...
<?php } //if footer_nav ?>
  <div class="footer-02">
    <div class="fixed_banner pc">
      <a href="#table" onclick="gtag('event', 'footer', {'event_category': 'pc','event_label': 'fixed_button'});">
    ...
    <div class="fixed_banner sp">
      <a href="#table" onclick="gtag('event', 'footer', {'event_category': 'sp','event_label': 'fixed_button'});">
        <img src="/wp-content/themes/xeory_base/img/button_top_sk_sp.png">
      </a>
    </div>
...
$('#menu-item-9,#menu-item-459').click(function(){
  $(window).off();
});
