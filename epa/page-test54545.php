...
<div id="content">
  ...
  <?php include_once("koumoku-2.php"); ?>

	<!-- /.koumoku -->

	 <?php include_once("table-2.php"); ?>
	 <?php include_once("epa-2.php"); ?>
	 <?php include_once("suntory-2.php"); ?>
	 <?php include_once("kinari-2.php"); ?>
	 <?php include_once("taisho-2.php"); ?>
	 <?php include_once("yamada-2.php"); ?>
